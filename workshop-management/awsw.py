...
#   audit     잔여 리소스 스캔 (읽기 전용)
#   clean     잔여 리소스 스캔 후 삭제 (audit --delete)
#   cost      전일 비용 리포트
...
from commands import setup, teardown, audit, cost, check, tag, admin, status, creds, workflow
...
cli.add_command(audit.clean_cmd,  name="clean")   # clean = audit --delete 의 별칭
